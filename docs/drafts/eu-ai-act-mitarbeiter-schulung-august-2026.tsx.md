# B3a Hub-Artikel-Entwurf — EU AI Act Mitarbeiter-Schulungspflicht (August 2026)

> **Status:** Entwurf zum Review. Zum Aktivieren die Schritte in `eu-ai-act-deployment-checklist.md` ausführen.
> **Zieldatei:** `src/pages/EuAiActMitarbeiterSchulung.tsx`
> **Slug:** `/wissen/eu-ai-act-mitarbeiter-schulung-august-2026`
> **Autor:** Martin Lang
> **Erstellt:** 09.06.2026 (vorgezogen aus dem geplanten Cron-Lauf 15.06.)
>
> **Faktencheck (recherchiert 09.06.2026):**
> - Artikel 4 EU-KI-VO gilt seit **2. Februar 2025** — die KI-Kompetenz-Pflicht ist also bereits in Kraft.
> - Die **Durchsetzung durch nationale Marktüberwachungsbehörden startet am 2. August 2026.** In Deutschland übernimmt das BSI die Marktaufsicht.
> - Die Pflicht gilt für **alle KI-Systeme** (Anbieter *und* Betreiber), nicht nur Hochrisiko-KI — auch beim reinen Einsatz von ChatGPT, Copilot & Co.
> - Statistik-Anker (DE): 64 % bezeichnen sich als „KI-Nachzügler", 43 % bieten keine KI-Schulungen, nur 27 % haben überhaupt Schulungen aufgesetzt — bei 56 %, die KI bereits aktiv nutzen.
> - Quellen: siehe Quellen-Sektion unten.
...
## Eintrag für `src/data/articles.ts` (am ANFANG des ALL_ARTICLES-Arrays einfügen)
