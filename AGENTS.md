...
- Codex macht Datei-Änderungen im lokalen Ordner
- User reviewed Änderungen in GitHub Desktop vor dem Commit
- Codex pusht NICHT eigenständig (außer User fordert es explizit an)
...
Codex pusht NUR wenn der User es explizit anfordert. Ansonsten: Änderungen bereitstellen, User commitet via GitHub Desktop.
...
Kontinuierliche SEO und GEO verbesserung. Fokus auf GEO
