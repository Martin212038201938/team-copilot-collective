...
const moduleCategories: ModuleCategory[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: "bessere-entscheidungen", title: "Bessere Entscheidungen mit Copilot: Bias, Noise und Entscheidungsqualität", tiers: ["paid"], category: "m365-advanced", note: "Dozentin: Saskia Kaden, Lead Trainerin Online" },
    ]
  },
  {
    id: "lernreise",
    title: "Copilot Lernreise",
    description: "Begleitete Lernreise für nachhaltigen Kompetenzaufbau – Inhalte frei kombinierbar",
    modules: [
      { id: "woche1", title: "Copilot Grundlagen – Interface, erste Prompts + Use Case: E-Mail-Zusammenfassungen", tiers: ["paid"], category: "lernreise" },
      { id: "woche2", title: "Copilot in Word – Dokumente erstellen + Use Case: Protokoll aus Meeting-Notizen", tiers: ["paid"], category: "lernreise" },
      { id: "woche3", title: "Copilot in Excel – Datenanalyse, Formeln + Use Case: Monatsbericht automatisieren", tiers: ["paid"], category: "lernreise" },
      { id: "woche4", title: "Copilot in PowerPoint + Use Case: Pitch-Deck aus Briefing", tiers: ["paid"], category: "lernreise" },
      { id: "woche5", title: "Copilot in Outlook + Use Case: Wöchentliche Status-Mail automatisieren", tiers: ["paid"], category: "lernreise" },
      ...
      { id: "bessere-entscheidungen-lernreise", title: "Bessere Entscheidungen mit Copilot: Bias, Noise und Entscheidungsqualität (auch als 4h-Workshop buchbar)", tiers: ["paid"], category: "lernreise", note: "Dozentin: Saskia Kaden, Lead Trainerin Online" },
    ]
  },
  {
    id: "compliance",
