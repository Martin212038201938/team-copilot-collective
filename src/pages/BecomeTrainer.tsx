            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="relative inline-block mb-6">
                ...
                <div className="relative bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border-2 border-primary/30 rounded-xl px-8 py-6">
                  <span className="px-4 py-2 bg-gradient-to-r from-primary/90 to-accent/80 text-white rounded-full text-sm font-medium shadow-lg inline-block animate-fade-in mb-4">
                    Join Our Team
                  </span>
