            ...
            <Card className="border-l-4 border-l-green-500">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-3">
                  ...
                  nicht nur die technische Bereitstellung von Lizenzen. In mitbestimmten Betrieben gehört dazu auch, frühzeitig <Link to="/wissen/copilot-betriebsrat" className="text-primary hover:underline">den Betriebsrat einzubinden</Link>.
                </p>
                <p className="font-semibold mb-2">Typischer Fehler</p>
                <p className="text-muted-foreground">
