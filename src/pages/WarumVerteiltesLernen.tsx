      ...
      >
        ...
        <section id="warum-4x2" className="mb-12">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <p>
              Zwischen den Sessions passiert etwas Entscheidendes: Die Teilnehmenden gehen zurück an ihren Arbeitsplatz und setzen das Gelernte in echten Aufgaben ein. Sie testen Copilot in Outlook mit ihren tatsächlichen E-Mails. Sie probieren Prompts in Word an Dokumenten, die sie sowieso schreiben müssen. Dieses unmittelbare Ausprobieren ist der eigentliche Transfermoment – und er fehlt bei einer Tagesschulung komplett, weil dort ein Inhalt den nächsten jagt. Weil die Einheiten kurz sind, funktioniert das Format auch verteilt und ortsunabhängig als <Link to="/wissen/microsoft-copilot-schulung-online" className="text-primary hover:underline">Online-Copilot-Schulung</Link>. Wer den Effekt dauerhaft in der Organisation verankern will, kann zusätzlich <Link to="/wissen/interne-copilot-trainer-ausbilden" className="text-primary hover:underline">interne Copilot-Trainer ausbilden</Link>.
            </p>
            <p>
