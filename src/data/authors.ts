...
export const authors: Record<string, Author> = {
  ...
  'martin-lang': {
    ...
    qualifications: [
      ...
      'Head of Agile / Agile Coach bei der ControlExpert GmbH (2019–2021), anschließend Interims-Geschäftsführer und Head Trainer beim Deutschland-Aufbau der Agile Scrum Group GmbH (2021–2022)',
      'Gründer & Geschäftsführer von bNear.io (2022–2024), einem Startup für virtuelle Büros in Microsoft Teams – 2024 erfolgreich verkauft an Solutions2Share',
      'Professional Scrum Master II (Scrum.org, 2026), zertifiziert in Microsoft Copilot Praxis (Microsoft, 2025)',
      'Seit 2011 in digitaler und agiler Transformation tätig (15+ Jahre)'
    ],
    ...
    profileText: [
      'Martin Lang hat Wirtschaftswissenschaften an der Universität Bielefeld studiert und sein Studium 2005 als Diplom-Betriebswirt mit Schwerpunkt Marketing und Kommunikation an der Hochschule Pforzheim abgeschlossen. Seine ersten Berufsjahre verbrachte er im klassischen Marketing: als Business Consultant bei einer Kommunikationsberatung mit Kunden wie Metabo und BMW, danach als Marketing Manager Deutschland/Österreich bei MV Agusta Motor S.p.A., wo er die Marken der italienischen Motorradhersteller MV Agusta und Cagiva im deutschsprachigen Raum verantwortete.',
      'Es folgten knapp fünf Jahre bei Dell in der EMEA-Organisation – zunächst als PR Consultant beim Aufbau der ersten Social-Media-Aktivitäten des Konzerns in Zentraleuropa, dann als Segment Marketing Manager für den öffentlichen Sektor und zuletzt als SMB Channel Brand Manager EMEA, wo er das paneuropäische Marketing-Team für mehr als 30.000 Fachhandelspartner mit aufgebaut hat. Diese Konzernerfahrung prägt bis heute seinen Blick auf Trainings: Wissen muss im echten Arbeitsalltag großer Organisationen funktionieren, nicht nur auf der Bühne.',
      '2011 gründete Martin Lang Yellow-Boat Consulting und begleitete von dort aus mehr als ein Jahrzehnt lang Digitalisierungs- und Transformationsprojekte in Konzernen und im Mittelstand – unter anderem für die Deutsche Telekom und congstar, Uniper, BSH Bosch/Siemens Hausgeräte, das DFKI, REWE, Lekkerland und Pernod Ricard. Zwischen 2019 und 2022 verantwortete er zusätzlich als Head of Agile / Agile Coach den Aufbau agiler Strukturen bei der ControlExpert GmbH und half anschließend als Interims-Geschäftsführer und Head Trainer beim Markteintritt der Agile Scrum Group in Deutschland.',
      'Von 2022 bis 2024 gründete und führte er parallel bNear.io, ein Startup für virtuelle Büros in Microsoft Teams, das 2024 erfolgreich an Solutions2Share verkauft wurde – seither begleitet er das Unternehmen als externer Berater. Aus dieser Kombination aus Konzern-, Berater- und Gründererfahrung entstand 2025 die copilotenschule.de: ein Spezialanbieter, der sich ausschließlich auf Anwenderschulungen rund um Microsoft Copilot konzentriert.',
