...
export const workshops: Workshop[] = [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "5-Phasen-Rollout-Strategie",
      steps: [
        "Ist-Analyse: Lizenzsituation, Use-Case-Landschaft, Change-Readiness, Governance-Status",
        "Use-Case-Priorisierung: High-Impact-Prozesse identifizieren, nach Wirkung und Umsetzbarkeit scoren",
        "Business Case: ROI-Modell mit Zeitersparnis, Qualitätsgewinn und strategischem Wert",
        "Rollout-Roadmap: Pilot-Welle, Skalierungs-Wellen, KPIs, Governance, Champions-Programm",
        "Change-Plan: Kommunikation, Schulung, Widerstandsmanagement, Wirkungsmessung",
      ],
    },
    features: [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "4-Phasen-Build-Zyklus für Copilot-Studio-Agenten",
      steps: [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "Copilot-Mitbestimmungs-Framework",
      steps: [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "Hackathon-Methodik für Business-Teams",
      steps: [
        "Kick-off & Challenge-Briefing: Gemeinsame Ausgangslage, Regeln, Teams",
        "Ideation: Use Cases identifizieren, Problem klar schärfen, Ansätze skizzieren",
        "Build: Teams entwickeln Prototypen mit Copilot – Prompt-Stacks, Workflows, Dokumente",
        "Pitch: 3-5 Minuten pro Team vor Jury und Publikum",
        "Award & Transfer: Auszeichnung, Dokumentation, Plan für Weiterführung der besten Ideen",
      ],
    },
    features: [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "4-Akt-Keynote-Aufbau",
      steps: [
        "Einstieg: Das Bild der veränderten Wissensarbeit – konkret und anschlussfähig",
        "Möglichkeiten: Live-Demos aus Word, Excel, PowerPoint, Outlook und Teams",
        "Grenzen & Verantwortung: Was KI nicht kann, Compliance, Führungsperspektive",
        "Aufbruch: Erfolgsfaktoren für erfolgreiche Einführungen und die nächsten Schritte",
      ],
    },
    features: [
  ...
  // -----------------------------------------------------------------
  {
    ...
    framework: {
      name: "Eventtag-Zonen-Konzept",
      steps: [
        "Welcome-Zone: Onboarding, Überblick, Lust-aufs-Thema-Machen",
        "Demo-Insel: Eindrückliche Live-Demos aus Word, Excel, PowerPoint, Outlook, Teams",
        "Hands-on-Station: Erste eigene Schritte unter professioneller Anleitung",
        "Challenge-Zone: KI-Quizze, Prompt-Challenges, Team-Wettbewerbe, Gewinnspiele",
        "Beratungs-Counter: Individuelle Fragen zu eigenen Use Cases",
      ],
    },
    features: [
      "Professioneller Infostand: Ganztägig besetzte Station mit kompetenten Ansprechpartner:innen für alle Copilot-Fragen",
      "Live-Demonstrationen: Eindrückliche Use Cases, die zum Staunen und Ausprobieren einladen",
      "Interaktive KI-Challenges: Teams treten gegeneinander an – wer löst Aufgaben am schnellsten mit Copilot?",
      "Gamification und Gewinnspiele: Spielerisch lernen mit Quizzen, Rätseln und attraktiven Preisen",
      "Hands-on-Stationen: Selbst ausprobieren unter Anleitung – erste Erfolgserlebnisse an Tag 1",
      "Individuelle Beratung: Persönliche Gespräche zu Use Cases aus dem eigenen Arbeitsbereich",
      "Hochwertige Infomaterialien: Cheat Sheets, Quick Guides und Tipps zum Mitnehmen (im Corporate Design)",
      "Foto-Dokumentation: Professionelle Bilder für die interne Kommunikation der nächsten Monate",
      "Follow-up-Paket: Zusammenfassung, Best Moments und nächste Schritte nach dem Event",
      "Flexible Gestaltung: Anpassbar an Location, Teilnehmerzahl, Corporate Identity und Themen-Schwerpunkte",
    ],
    targetAudience: [
